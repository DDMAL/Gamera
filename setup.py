...
if "--dated_version" in sys.argv:
    ...
    sys.arg.remove("--dated_version")

if "--compiler=mingw32_cross" in sys.argv:
    import mingw32_cross_compile
    sys.argv[sys.argv.index('--compiler=mingw32_cross')] = '--compiler=mingw32'
    cross_compiling = True

if "--openmp=yes" in sys.argv:
    has_openmp = True
    sys.argv.remove("--openmp=yes")
elif "--openmp=no" in sys.argv:
    sys.argv.remove("--openmp=no")
